...
const TeamsItem = ({ id, teamName, teamDesc, teamColor, date, assign, refetch }) => {
  const [opened, setOpened] = useState(false);
  const addTeamModalControll = () => {
  ...
  return (
    <>
      ...
      >
        ...
        <h4 className="mt-3 text-sm font-medium">{teamDesc}</h4>
